<template>
    <div id="LeftPreOrder">
        ...
        <div class="mui-inner-wrap">
            <div id="offCanvasContentScroll" class="mui-content mui-scroll-wrapper" style="margin-top: 0;background-color:#fff;">
                <div class="total_num" style="text-align:left;">
                    <span style="text-align:left;">总数量：</span><span class="set_all_num">{{count}}</span>
                </div>
                <!--下拉刷新容器-->
                <div id="pullrefresh" class="mui-scroll-wrapper main-body" ref="wrapper" :style="{ height: (wrapperHeight-10) + 'px' }"  style="z-index: 0;overflow-y:auto;padding-top:2rem;background-color:#fff;margin-top:.85rem">
    ...
    methods:{
            ...
            loadMore() {
                ...
                this.$http.post(url,setData).then((res)=>{
                    _.forEach(res.data[0].result,(value, key) => {
                        _this.ListArr[0].OrderList.push(value);
                        // _this.OrderListArr= _.concat(_this.OrderListArr,_this.orderArr)
                    });
